...
| Newton Bench               | math                  | - | Scientific law discovery through interactive experimentation (324 tasks, 12 physics domains) | Benchmark generalizable scientific law discovery in LLM agents | <a href='resources_servers/newton_bench/configs/newton_bench.yaml'>config</a>                                     | ✓     | -          | Apache 2.0 |
